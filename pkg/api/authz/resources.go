...
var apiResources = map[string][]string{
	...
	types.GroupPowerUserPlus: {
		...
		"GET    /api/workspaces/{workspace_id}/access-policies",
		"POST   /api/workspaces/{workspace_id}/access-policies",
		"DELETE /api/workspaces/{workspace_id}/access-policies/{id}",
		"GET    /api/workspaces/{workspace_id}/access-policies/{id}",
		"PUT    /api/workspaces/{workspace_id}/access-policies/{id}",
	},
