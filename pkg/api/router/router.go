...
func NewRouter(ctx context.Context, services *services.Services) (*Router, error) {
	...
	accessPolicies := handlers.NewAccessPolicyHandler()
	...
	mux.HandleFunc("GET /api/access-policies", accessPolicies.List)
	mux.HandleFunc("GET /api/access-policies/{id}", accessPolicies.Get)
	mux.HandleFunc("POST /api/access-policies", accessPolicies.Create)
	mux.HandleFunc("PUT /api/access-policies/{id}", accessPolicies.Update)
	mux.HandleFunc("DELETE /api/access-policies/{id}", accessPolicies.Delete)
	...
	mux.HandleFunc("GET /api/workspaces/all-access-policies", powerUserWorkspaces.ListAllAccessPolicies)
	mux.HandleFunc("GET /api/workspaces/all-servers/all-instances", powerUserWorkspaces.ListAllServerInstances)

	// Workspace-scoped MCP access policies (PowerUserPlus only)
	mux.HandleFunc("GET /api/workspaces/{workspace_id}/access-policies", accessPolicies.List)
	mux.HandleFunc("GET /api/workspaces/{workspace_id}/access-policies/{id}", accessPolicies.Get)
	mux.HandleFunc("POST /api/workspaces/{workspace_id}/access-policies", accessPolicies.Create)
	mux.HandleFunc("PUT /api/workspaces/{workspace_id}/access-policies/{id}", accessPolicies.Update)
	mux.HandleFunc("DELETE /api/workspaces/{workspace_id}/access-policies/{id}", accessPolicies.Delete)
