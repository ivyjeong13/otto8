...
func (p *KeygenProvider) configuredProviderViolationsForType(ctx context.Context, c kclient.Client, providerType types.ToolReferenceType) ([]ProviderViolation, error) {
