...
<main
	id="main-content"
	class="text-muted-content dark:bg-base-100 bg-base-200 flex min-h-dvh items-center justify-center px-4 py-16"
>
	<div
		class={twMerge(
				...
				<dl class="border-error/30 bg-error/10 space-y-4 rounded-md border p-4">
					<div class="flex items-start justify-between">
						<div>
							...
							<dd class="text-muted-content mt-1 font-mono text-sm break-all">{error}</dd>
						</div>
						<CopyButton
							showTextLeft
