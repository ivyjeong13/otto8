...
<div class="flex flex-col">
	<div class="mb-1 flex items-center justify-between">
		<p class="grow text-sm font-semibold">Custom Tools</p>
		<button
			class="icon-button"
			...
			>
				<div class="flex w-full min-w-0 items-center gap-3 py-2 pl-2">
					...
					<div class="flex min-w-0 flex-col text-left">
						<p class="truncate text-left text-xs font-light">
							{customTool.name || 'Untitled'}
						</p>
						<span class="truncate text-xs text-gray-500">{customTool.description}</span>
					</div>
				</div>
				<div class="py-2 pr-3 transition-opacity duration-200 group-hover:opacity-100 md:opacity-0">
