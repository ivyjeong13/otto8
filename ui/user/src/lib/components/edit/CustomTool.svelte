...
<script lang="ts">
	...
	import { Container, X, ChevronRight, Trash2, SquarePen, ChevronsLeft } from 'lucide-svelte';
...
<div class="flex h-full w-full flex-col">
	...
	<div
		class="dark:from-surface1 to-surface1 flex min-h-0 grow flex-col gap-4 bg-radial-[at_25%_25%] from-white to-75% shadow-inner dark:to-black"
	>
		<div class="default-scrollbar-thin relative flex grow flex-col gap-5 overflow-y-auto p-8">
			...
			<div
				class="bg-surface2 flex flex-col rounded-lg pb-1"
