...
{:else}
	<div class="flex flex-col gap-4 pb-8">
		<h2 class="mt-8 px-8 text-xl font-semibold">Slack</h2>
		<CollapsePane
			header="Configure Slack Integration"
			open={showSteps}
			classes={{
				header: 'pl-8 font-semibold',
				content:
					'pl-8 from-surface1 dark:from-surface1 bg-radial-[at_25%_25%] to-white to-75% dark:to-black'
			}}
		>
			{@render steps()}
		</CollapsePane>
