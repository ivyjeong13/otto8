...
export const HELPER_TEXTS = {
	...
	tasks:
		'Automated or one-off workflows that an project can perform for the user. Incorporate variables to make them dynamic or make them simple enough to meet your needs.',
	tables:
		'Stored information in a table-like format that have been created by and utilized by the project.',
	general:
	...
	customTools:
		'Custom tools are a way to extend the capabilities of the project. They can be used to perform actions that are not already available in the catalog.',
	starterFiles: 'Add files that are available to use/view by a user with every conversation.',
	interfaces: 'Hook up an project to third party services to automate tasks and workflows.',
	sharing:
